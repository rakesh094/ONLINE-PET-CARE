<%-- 
    Document   : forgot
    Created on : 14 Jun, 2024, 2:41:31 PM
    Author     : edula
--%>
    ...
    <body>
        ...
        <div id="right">
            ...
            <form action="verifyAction.jsp" method="post">
                <table>
                    <tr><td><input type="text" name="email" required="" placeholder="ENTER EMAIL"
                                   style="width:400px;height:35px;"></td></tr>
                     
                     <tr><td><input type="submit" value="verify Here" style="width:200px;height:40px;">
