...
<html>
    ...
    <body>
        <div id="main">
            ...
            <a href="Ask-Sugg.jsp"  class="active"> <div class="m2"><p  style="margin:0px;">ASK SUGGESTION</p></div></a> 
        ...
        <div id="left">
            <center><h2 style="color:whitesmoke;">ASK SUGGESTIONS</h2></center>
           
            <div id="ll" style="width:400px;height:250px;border:none; float:right;">
                <form action="AskAction.jsp" method="post">
                    <table>
                        <tR><th>ENTER PET NAME</th><td><input type="text" name="petname" required=""></td></tr>
                        <tR><th>ENTER PROBLEM</th><td><textarea cols="20" rows="10" name="problem"></textarea></td></tr>
<tr><th></th><td><input type="submit" value="Ask Suggestion"></tD></tr>
                    </table>
                </form>
